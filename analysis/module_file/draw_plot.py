...
def test_group_draw(raw):
    ...
    def test_group_accuracy(raw):
        ...
        plt.savefig('result_file/_10_test_group_accrucy.png', dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('result_file/_11_prediction_by_test_group.png', dpi=300)
...
def difference_by_count(raw, count=0):
    ...
    plt.tight_layout()
    plt.savefig('result_file/_20_difference_by_count.png', dpi=300)
...
def zero_one_by_count(raw, count=0):
    ...
    plt.tight_layout()
    plt.savefig('result_file/_21_prediction_value_by_prob_count.png', dpi=300)
...
def user_accuracy_prediction(raw, user_acc=0.6, check='upper'):
    ...
    plt.tight_layout()
    plt.savefig('result_file/_30_prediction_value_by_user_accuracy.png', dpi=300)
...
def total_time_with_prediction(raw):
    ...
    plt.tight_layout()
    plt.savefig('result_file/_40_total_time_to_solve')
